# Available .GIVES One-Word Domains (9,606)
...
Daily-updated dataset of available and resale .gives one-word domains from Unique Domains.
...
- `gives.csv` — public CSV extract (9,606 rows)
- `gives.json` — public JSON extract (9,606 rows)
